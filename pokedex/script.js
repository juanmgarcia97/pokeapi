...
class Pokedex extends HTMLElement {
  constructor() {
    ...
    let templateElem = document.getElementById('pokeCard');
    let content = templateElem.content.cloneNode(true);

    content.querySelector('.container>.image').setAttribute(
      'src',
...
let initPokedex = () => {
  dataPokemons.results.forEach((pokemon) => {
    let pokeElement = document.createElement('poke-card');
    pokeElement.setAttribute(
      'image',
      getPokemonImageUri(pokemon.url.split('/')[6])
    );
